...
[copyloadDate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__5CD6CB2B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Opportunity] ADD CONSTRAINT [PK__Opportun__736BF79C75827CDE] PRIMARY KEY CLUSTERED  ([opportunityid])
GO
