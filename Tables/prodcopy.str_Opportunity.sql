...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Oppor__copyl__7D0E9093] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Opportunity] ADD CONSTRAINT [PK__str_Oppo__0ACAF85A63AEC917] PRIMARY KEY CLUSTERED  ([str_opportunityid])
GO
