...
[copyloaddate] [datetime] NULL CONSTRAINT [copyloaddate_default] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__7126F91DE5B475D9] PRIMARY KEY CLUSTERED  ([contactid])
GO
