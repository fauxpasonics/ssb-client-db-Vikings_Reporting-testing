...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Sales__copyl__0880433F] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_SalesOrder] ADD CONSTRAINT [PK__str_Sale__F4B3FD818CEC10A9] PRIMARY KEY CLUSTERED  ([str_salesorderid])
GO
