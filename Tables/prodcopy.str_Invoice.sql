...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Invoi__copyl__0697FACD] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Invoice] ADD CONSTRAINT [PK__str_Invo__9A159A3644F8B08A] PRIMARY KEY CLUSTERED  ([str_invoiceid])
GO
